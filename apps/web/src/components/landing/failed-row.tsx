...
export function FailedRow({ row }: { row: FailedRowData }) {
  return (
    <div className="failed-row-hover grid grid-cols-1 md:grid-cols-[1fr_auto_auto_auto] items-center gap-2 md:gap-6 rounded-[2px] bg-cv-surface px-6 py-5">
      ...
      <span className="text-[9px] font-bold uppercase tracking-[0.08em] text-cv-failed bg-cv-failed/8 px-2.5 py-1 rounded-[2px] w-fit">
        {row.tag}
      </span>
      <span
        className="font-display text-2xl font-black text-cv-failed"
